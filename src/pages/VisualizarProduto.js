                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            <a class="navbar-brand" href="#pablo" style={{fontSize:'21px'}}>Visualizar Produtos</a>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <label style={{color:'#009fe3'}}>Quantidade</label>
                                                        <input type="text" class="form-control" id="quantidade" placeholder="Quantidade" disabled/>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                    <label style={{color:'#009fe3'}}>Preço R$</label>
                                                        <input type="text" class="form-control" id="preco" placeholder="Preço R$" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">                                                
                                                <div class="col-md-12">
                                                    ...
                                                    <label style={{color:'#009fe3'}}>Descrição</label>
                                                        <textarea class="form-control" rows="3" id="desc" placeholder="Descrição" disabled></textarea>
