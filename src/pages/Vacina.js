...
export default function Vacina(){
    ...
    async function AparecerSolicitadas(){
        ...
        let response="";
        try {
            response = await api.post('https://agendaanimal-backend.herokuapp.com/Vacina/buscarVacinasSolicitadas');
        } catch (error) {
            console.log(error);               
        }
    ...
    async function Confirmar(id){
        ...
        if(id === "" || id === null || id === undefined){
            ...
            let response="";
            try {
                response = await api.post('https://agendaanimal-backend.herokuapp.com/Vacina/AprovarVacinasSolicitadas', {idVacina:id});
            } catch (error) {
                console.log(error);               
            }
    ...
    async function Negar(id){
        ...
        if(id === "" || id === null || id === undefined){
            ...
            let response="";
            try {
                response = await api.post('https://agendaanimal-backend.herokuapp.com/Vacina/NegarVacinasSolicitadas', {idVacina:id});
            } catch (error) {
                console.log(error);               
            }
