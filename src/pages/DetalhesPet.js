    ...
    if(id === "" || id === null || id === undefined){
      ...
      if(response){
        if(response.data.response){
          ...
          var dateCorretoAniver = dateInicioAniver[8] + dateInicioAniver[9] +  dateInicioAniver[7] + dateInicioAniver[5] + dateInicioAniver[6] +  dateInicioAniver[4] +  dateInicioAniver[2] + dateInicioAniver[3] + dateInicioAniver[0]  + dateInicioAniver[1]  ;
          ...
          if(produto[0].statusAgen === "Negado" || produto[0].statusAgen === "Confirmado"){
            document.getElementById("tableAgend").style.display= "none";
            document.getElementById("tableAgendButton").style.display= "none";
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">               
                <div class="card-body table-responsive">
                  <table class="table  " style={{marginBottom:'0px',borderBottom:'1px solid #dcdcdc'}}>
                    <tbody>
                  ...
                  <table class="table " style={{marginBottom:'0px'}} id="tableAgend">
                    <tbody>
                        <tr style={{width: '100%',background:'none'}}>      
                            <td style={{paddingBottom:'03px'}}>   
                  ...
                  <div style={{width: '100%',textAlignLast: 'center'}} id="tableAgendButton">
